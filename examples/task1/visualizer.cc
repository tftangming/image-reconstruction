...
namespace
{
    ...
    void
    draw_box (core::ByteImage& image, float x, float y,
    ...
    Visualizer::KeypointStyle style)
{
    ...
    if (image->channels() == 3)
    {
        ret = core::image::desaturate<unsigned char>(image, core::image::DESATURATE_AVERAGE); /*减小饱和度*/
        ret = core::image::expand_grayscale<unsigned char>(ret);/*扩展灰度值*/
    }
    ...
    uint8_t* color = color_table[3]; /*{ 255, 255, 0 }*/
